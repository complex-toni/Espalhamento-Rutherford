...
dt::Float64 = 1 * 1e-15 # passo em fs. # valor normal = 300*1e-15
...
z0::Float64 = -50 * escala # Componente z da posição inicial do núcleo (a t = t0) - em m - Assumimos eixo z paralelo ao momentum inical da partícula
...
N::Int64 = 5000 # Número de passos a serem calculados na simulacao.
...
parametros_impacto = [1.25 * escala]

# definir a geometria da malha atômica (input)
n_atomos_por_camada = 1
n_camadas = 1
distancia_entre_atomos = 1.66 * escala
